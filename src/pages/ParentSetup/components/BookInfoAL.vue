    ...
    <div class="panel">
        ...
        <div class="colcenter">
            <CircleGraph 
                ...
                size="350"
                />
            <img :src="infoThumb" style="margin:0.5rem 0" />
        </div>
        ...
        <div class="description"> 
            ...
            <div class="row">
                <div class="marker" />
                <div class="lineValue"> <div class="title">미완성 {{this.title}}</div></div>
            </div>
            <div class="row"> <span class="comment">{{this.wordsString}}</span></div>
...
export default class BookInfo extends Vue {
    ...
    @Prop({default:()=>[]}) private notCompleted: Array<string>;

    get wordsString(): string{
        let result = "";
        for( const v of this.notCompleted){
            result += v;
            if( this.notCompleted.indexOf(v) < this.notCompleted.length-1 ){
                result += ", ";
            }
        }
        return result;
