...
abstract class MarkerBase extends PIXI.Container{
    ...
    hitTest( globalX: number, globalY: number ): boolean{
        ...
        // console.log("->",localPos.x,localPos.y, len, len< (sMarkerRange*sMarkerRange));
...
class Segment extends PIXI.Graphics{
    ...
    _refreshDraw(){
        ...
        if( this.mStartMarker && this.mEndMarker ){
            ...
            // console.log("controlPos:", this.controlPos.x, this.controlPos.y );
...
// 퀴즈용 디스플레이
    ...
    changeColor(color: number){
        this.mOutlineImage.tint=color;
        this.mFilledImage.tint= 0x0f2951 ;
    }
